...
_DJANGO_ALLOWED_HOSTS = env("DJANGO_ALLOWED_HOSTS", default="localhost, 0.0.0.0, 127.0.0.1, 192.168.0.2")
...
# STATIC
# ------------------------
# STATICFILES_STORAGE = "config.settings.local.StaticRootGoogleCloudStorage"
